...
export default function PaymentCalculator() {
  ...
  const clear = () => {
    setLoanAmount(20000); setLoanTerm(5);
    setTermUnit("years"); setInterestRate(6.5); setResult(null);
  };

  return (
    <div className="mc-page">
      <div className="mc-breadcrumb">
        <Link href="/">home</Link> / <Link href="/">financial</Link> / payment calculator
      </div>

      <div className="mc-layout">
        <div className="mc-main">
          <h1 className="mc-title">Payment Calculator</h1>
